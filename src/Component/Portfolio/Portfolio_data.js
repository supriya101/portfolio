const Portfolio_data = [
  ...
  },
  {
    ...
    category: "WORDPRESS",
    totalLike: "Project 3",
    title: "Client - firstcry intelli",
    image: "images/first2n.png",
    desc: "Worked on the article blueprint for the FirstCry Intelli Education website, focusing on early childhood learning and parenting topics.",
    ...
    skills: "Skills Demonstrated: Content creation & strategy, SEO optimization, Meta tag implementation, Parenting niche expertise, Content Management System (CMS), Google Analytics, and SEO plugins.",
  ...
  },
  {
    ...
    image: "images/mallikarjun-1.png",
    ...
    desc2: "Used best SEO techniques to increase visibility in search results.",
    skills: "Developed and managed social media content for CPImallikarjun.",
...

    {
      ...
      image: "images/jcloud-day-1.png",
      desc: "Designed the UI/UX for the JCloud Day platform, a website that provides a means for organizers to advertise conferences online.",
      desc2: "Worked in groups to identify client requirements and converted requirements into eye-catching design solutions. ",
      skills: "Conducted thorough user research and usability testing, utilizing the insights to improve the JCloud Day platform's user interface for a user-friendly experience.",
